...
* link:#external-component[*`External`*] : Stores the API of other software used.
...
It is highly important to build a sustainable and effective software system for both users and developers of CYNC. As such,
we have dedicated a section on testing to aid you on writing and executing your test cases.
[TIP]
